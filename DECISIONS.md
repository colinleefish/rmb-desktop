...
| 2026-09-12 | Corrections stay pinned at distill time (no auto-absorb on version bump). Memories Corrections tab dropped — overrides are not a memory category; add/retract live on the target memory detail | `.harness/contracts/F12.md` |
